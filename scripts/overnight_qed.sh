...
python -u scripts/run_experiment.py --theory QED --protocol record --seeds 0 \
  ...
  --epochs 30 --patience 12 --eval-every 4 --out results/QED_record_seed0.json
python -u scripts/run_experiment.py --theory QED --protocol template --seeds 0 \
  --arms full_vanilla_dense math_only graph_only \
  --epochs 30 --patience 12 --eval-every 4 --out results/QED_template_seed0.json
python -u scripts/run_experiment.py --theory QED --protocol record --seeds 1 2 \
  ...
  --epochs 30 --patience 12 --eval-every 4 --out results/QED_record_seeds12.json
